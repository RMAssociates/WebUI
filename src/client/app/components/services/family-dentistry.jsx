...
const familyDentistry = () => (
  <div>
      ...
      <h4>THE ATTENTION YOU DESERVE</h4>
      <p> When you come to us, our dentistry professionals will listen closely to your concerns and provide you with the information and guidance you need to make the right treatment-related decisions. Once we’ve outlined a custom treatment plan, we'll do everything we can to provide a positive patient experience.
          </p>
    <p>At Leaside Village Dental, your teeth are our top priority. Call today for your appointment and see what our talented team can do for your smile.</p>
  </div>
);
