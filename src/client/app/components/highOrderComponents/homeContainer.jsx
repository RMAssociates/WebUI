...
export const HomeContainer = () => (
  <div>
    ...
    <div className="row">
      <h4 className="alert-warning my-3 font-weight-bold">COVID-19 Update - We are glad to inform you that we are continuing to provide oral health care to our patients during this time.          
      </h4>
      <p className="alert-warning">However, we request any patients who have tested positive for Covid-19
      or come in contact with someone who has tested positive or has had acute respiratory illness, 
      to kindly wait until they have consulted their physician
      and/or are symptom free following 14 days of self isolation prior to booking an appointment.
    We thank you for your understanding and help in ensuring that we remain a Covid-19 free office. 
    We look forward to seeing you again and are happy to answer any questions you may have about
